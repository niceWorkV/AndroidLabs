package com.maksymov.randomgallery.screens.details;
...
import com.maksymov.randomgallery.GalleryRequestHandler;
...
public class DetailsFragment extends Fragment implements GalleryListener {
    ...
    public void onGotGalleryPhotos(List<LocalPhoto> photos) {
        MainThreadHandler.run(() -> {
            ...
            if (photo != null) {
                picasso.load(GalleryRequestHandler.localPhotoToUrl(photo)).into(photoImageView);
